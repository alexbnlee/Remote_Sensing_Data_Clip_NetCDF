PRO Data_Clip_NC_2_EVENT, event
...
PRO Data_Clip_NC_2
  ...
  tlb_71 = WIDGET_BASE(tlb_7, uname = 'tlb_71', /row)
  ...
  droplist_72 = WIDGET_DROPLIST(tlb_71, uname = 'droplist_72',$
    value=sea_areas)
  ...
  WIDGET_CONTROL, droplist_71, $
    scr_xsize = (info_tlb_71.scr_xsize - 8)/2 - 20
  WIDGET_CONTROL, droplist_72, $
    scr_xsize = (info_tlb_71.scr_xsize - 8)/2
  ...
  XMANAGER, 'Data_Clip_NC_2', tlb, /no_block
